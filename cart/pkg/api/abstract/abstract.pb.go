...
const file_abstract_proto_rawDesc = "" +
	"\n" +
	"\x0eabstract.proto\"E\n" +
	"\x0fGeneralResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageB Z\x1ecart/pkg/api/abstract;abstractb\x06proto3"

var (
	file_abstract_proto_rawDescOnce sync.Once
	file_abstract_proto_rawDescData []byte
)

func file_abstract_proto_rawDescGZIP() []byte {
	file_abstract_proto_rawDescOnce.Do(func() {
		file_abstract_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_abstract_proto_rawDesc), len(file_abstract_proto_rawDesc)))
	})
	return file_abstract_proto_rawDescData
}

var file_abstract_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_abstract_proto_goTypes = []any{
...
func file_abstract_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_abstract_proto_rawDesc), len(file_abstract_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
